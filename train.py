...
def train(ssim_weight, original_imgs_path_name, source_a_imgs_path, source_b_imgs_path_name, encoder_path, save_path, debug=False, logging_period=10):
    if debug:
    ...
    with tf.Graph().as_default(), tf.Session() as sess:
        ...
        print('original img shape:', original.shape)
